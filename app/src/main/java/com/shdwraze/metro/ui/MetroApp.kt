...
fun MetroApp() {
    ...
    Scaffold(
        ...
        Surface(
            ...
            val metroViewModel: MetroViewModel = viewModel(factory = MetroViewModel.Factory)
...
@Composable
fun MetroTopAppBar(scrollBehavior: TopAppBarScrollBehavior, modifier: Modifier = Modifier) {
